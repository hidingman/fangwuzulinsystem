			...
			<view :style='{"minHeight":"100%","padding":"0 20rpx","flexWrap":"wrap","background":"#FFFBF3","display":"flex","width":"100%","position":"relative","height":"auto"}'>
				...
				<view :style='{"width":"100%","background":"none","flexDirection":"column","display":"flex","height":"auto","order":"5"}'>
					...
					<view class="news-box6" :style='{"width":"100%","padding":"24rpx 0","margin":"0","height":"auto"}'>
						<view @tap="onDetailTap(product)" v-for="(product,index) in list" :key="index" class="list-item" :style='{"width":"100%","padding":"8rpx 24rpx 8rpx 80rpx","margin":"0 0 20rpx","position":"relative","background":"#fff","height":"auto"}'>
							<view :style='{"padding":"0","margin":"-36rpx 0 0 0","borderColor":"#E4EFBE","color":"#E4EFBE","textAlign":"center","borderRadius":"100%","top":"50%","left":"0","borderWidth":"2rpx","width":"72rpx","lineHeight":"68rpx","fontSize":"28rpx","position":"absolute","borderStyle":"solid","height":"72rpx"}' class="num">
								<view style="width: 100%;height: 100%;position: absolute;left: 0;top: 0;" :style="{transform: 'rotate('+(-index*60)+'deg)'}" class="dian">
									<view :style='{"transform":"translateX(-50%)","borderRadius":"100%","top":"-8rpx","left":"50%","background":"#E4EFBE","width":"16rpx","position":"absolute","height":"16rpx"}' />
