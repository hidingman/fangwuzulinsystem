	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.hetongbianhao" label="合同编号" prop="hetongbianhao" >
					<el-input v-model="ruleForm.hetongbianhao" placeholder="合同编号" readonly></el-input>
				</el-form-item>
				<el-form-item class="upload" v-if="type!='info'&& !ro.hetongfujian" label="合同附件" prop="hetongfujian" >
					<file-upload
						tip="点击上传合同附件"
						action="file/upload"
						:limit="1"
				...
				<el-form-item v-else-if="ruleForm.hetongfujian" label="合同附件" prop="hetongfujian" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.hetongfujian)">
				...
				<el-form-item class="date" v-if="type!='info'" label="签订时间" prop="qiandingshijian" >
					<el-date-picker
				...
				<el-form-item class="input" v-else-if="ruleForm.qiandingshijian" label="签订时间" prop="qiandingshijian" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="合同事项" prop="hetongshixiang" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="合同事项"
					v-model="ruleForm.hetongshixiang" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.hetongshixiang" label="合同事项" prop="hetongshixiang" >
				<span class="text">{{ruleForm.hetongshixiang}}</span>
			</el-form-item>
			<el-form-item v-if="type!='info'"  label="合同详情" prop="hetongxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.hetongxiangqing" 
					class="editor"
					myQuillEditor="hetongxiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.hetongxiangqing" label="合同详情" prop="hetongxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.hetongxiangqing"></span>
			</el-form-item>
		...
		data() {
			...
			return {
				...
				ro:{
					...
					hetongxiangqing : false,
					hetongshixiang : false,
					gonghao : false,
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='hetongxiangqing'){
							this.ruleForm.hetongxiangqing = obj[o];
							this.ro.hetongxiangqing = true;
							continue;
						}
						if(o=='hetongshixiang'){
							this.ruleForm.hetongshixiang = obj[o];
							this.ro.hetongshixiang = true;
							continue;
						}
						if(o=='gonghao'){
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.hetongxiangqing = this.ruleForm.hetongxiangqing.replace(reg,'../../../fangwuzulinsystem/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
