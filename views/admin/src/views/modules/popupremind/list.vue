		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"10px","background":"#fff","display":"flex"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}' class="select" label="类型" prop="type">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">类型</label>
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">提醒时间</label>
						<el-date-picker v-model="searchForm.remindtimestart" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" placeholder="提醒时间起始"></el-date-picker>
						至
						<el-date-picker v-model="searchForm.remindtimeend" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" placeholder="提醒时间结束"></el-date-picker>
					</div>
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.type!='' && this.searchForm.type!=undefined){
 				...
 				if(this.searchForm.remindtimestart!='' && this.searchForm.remindtimestart!=undefined ){
					params['remindtimestart'] = this.searchForm.remindtimestart
				}
				if(this.searchForm.remindtimeend!='' && this.searchForm.remindtimeend!=undefined){
					params['remindtimeend'] = this.searchForm.remindtimeend
				}
