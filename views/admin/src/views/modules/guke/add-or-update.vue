<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="需求" prop="xuqiu" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="需求"
					v-model="ruleForm.xuqiu" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.xuqiu" label="需求" prop="xuqiu" >
				<span class="text">{{ruleForm.xuqiu}}</span>
			</el-form-item>
