	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="打卡类型" prop="dakaleixing" >
				...
				<el-form-item class="input" v-else-if="ruleForm.dakashijian" label="打卡时间" prop="dakashijian" >
			...
			<el-form-item v-if="type!='info'"  label="打卡详情" prop="dakaxiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.dakaxiangqing" 
					class="editor"
					myQuillEditor="dakaxiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.dakaxiangqing" label="打卡详情" prop="dakaxiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.dakaxiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.dakaxiangqing = this.ruleForm.dakaxiangqing.replace(reg,'../../../fangwuzulinsystem/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
