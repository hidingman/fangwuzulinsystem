<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item v-if="type!='info'"  label="预约详情" prop="yuyuexiangqing" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.yuyuexiangqing" 
					class="editor"
					myQuillEditor="yuyuexiangqing"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.yuyuexiangqing" label="预约详情" prop="yuyuexiangqing" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.yuyuexiangqing"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.yuyuexiangqing = this.ruleForm.yuyuexiangqing.replace(reg,'../../../fangwuzulinsystem/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
